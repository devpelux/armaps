...
{
    /// <summary>
    /// Applies a default feathering effect at the edge of the detected plane,
    /// which reduces the visual impression of a hard edge.
    /// (From ARCore default assets)
    /// </summary>
    [RequireComponent(typeof(ARPlaneMeshVisualizer), typeof(MeshRenderer), typeof(ARPlane))]
    public class FeatheredPlaneMeshVisualizer : MonoBehaviour
    {
        ...
        void GenerateBoundaryUVs(Mesh mesh)
        {
            ...
            Vector3 centerInPlaneSpace = s_Vertices[^1];
        ...
        static readonly List<Vector3> s_FeatheringUVs = new();
